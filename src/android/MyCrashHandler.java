...
public class MyCrashHandler implements UncaughtExceptionHandler {
	...
	public void init(Context context) {
		...
		SdkProxy.init(context.getApplicationContext());
	}
...
//			extras.putAll(infos);
//			extras.put("crash-log", result.replace("\r", "\\r").replace("\n", "\\n"));
//			SdkProxy.onEvent("onCrash", extras);
			...
			if (Environment.getExternalStorageState().equals(
				...
				String path = Environment.getExternalStorageDirectory() + "/.android/.crash/";
